...
class AIChatApp(QMainWindow):
    ...
    def create_setup_tab(self) -> QWidget:
        ...
        self.url_input = QLineEdit("https://api.example.com/v1")
    ...
    def create_chat_tab(self) -> QWidget:
        ...
        self.model_combo.addItems(["gpt-4", "gpt-3.5-turbo", "claude-2", "llama-3"])
    ...
    def handle_api_response(self, response: Dict[str, Any]) -> None:
        ...
        if "choices" in response and len(response["choices"]) > 0:
            ...
            self.chat_history.append(f"<b>AI:</b> {assistant_reply}")
            ...
            self.chat_history.append("<b>AI:</b> [无回复]")
